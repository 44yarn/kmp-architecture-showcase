...
main() {
  ...
  DESCS+=("🧩 Build iOS XCFramework: :shared:assembleShowcaseKitDebugXCFramework"); CMDS+=("./gradlew :shared:assembleShowcaseKitDebugXCFramework"); HINTS+=("Required before Xcode builds. After 'gradlew clean', this step regenerates the XCFramework so the SPM binaryTarget in shared/Package.swift can resolve.")
